...
kickFrame.Size = UDim2.new(0, 200, 0, 90)
kickFrame.Position = UDim2.new(0, 50, 0, 170)
kickFrame.BackgroundColor3 = Color3.fromRGB(60, 0, 0)
kickFrame.BorderSizePixel = 0
kickFrame.Parent = page3

local drop = Instance.new("TextButton")
drop.Size = UDim2.new(1, 0, 0, 35)
drop.BackgroundColor3 = Color3.fromRGB(140, 0, 0)
drop.Text = "Select Player"
drop.TextColor3 = Color3.new(1,1,1)
drop.Parent = kickFrame

local listFrame = Instance.new("Frame")
listFrame.Size = UDim2.new(1, 0, 0, 120)
listFrame.Position = UDim2.new(0, 0, 1, 0)
listFrame.BackgroundColor3 = Color3.fromRGB(40, 0, 0)
listFrame.Visible = false
listFrame.Parent = kickFrame
...
kickButton.Size = UDim2.new(1, 0, 0, 35)
kickButton.Position = UDim2.new(0, 0, 0, 55)
kickButton.BackgroundColor3 = Color3.fromRGB(140, 0, 0)
kickButton.TextColor3 = Color3.new(1,1,1)
kickButton.Text = "Kick Selected"
kickButton.Parent = kickFrame

kickButton.MouseButton1Click:Connect(function()
    if selectedPlayer then
        selectedPlayer:Kick("Join us we are the RedGlitchKing.")
    end
end)
